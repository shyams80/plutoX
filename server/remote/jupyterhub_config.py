...
c.GitHubEnvAuthenticator.enable_auth_state = True

c.GitHubEnvAuthenticator.create_system_users = True
...
#c.Spawner.args = ["--NotebookApp.nbserver_extensions=", "{'Hello.HelloWorld': True}"]

#c.Spawner.nbserver_extensions = {"Hello.HelloWorld": True}
